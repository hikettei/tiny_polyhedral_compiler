...
constant_folder = Simplifier(
    ...
    [(
        ...
        (lambda op: (lambda x: ir.Const.new(op.python_op(x.value), x.T[0].dtype) # type: ignore
    ...
    [(
        ...
        (lambda op: (lambda a, b: ir.Const.new(op.python_op(a.value, b.value), a.T[0].dtype) # type: ignore
                     if (a.T[0].dtype == b.T[0].dtype and _is_num(a.value) and _is_num(b.value)) else None))(op),
